...
<body>
    ...
    <?php echo form_open(base_url('/admin/index/login'));?>
    <!-- <form action="index.php?c=index" method="post" name="login">-->
		<table width="290" border="0" align="center" cellpadding="6"
			cellspacing="0">
			<tr>
				<td width="60">用户名：</td>
				<td><label> <input name="username" type="text" class="input_1" id="username" />
				</label></td>
			</tr>
			<tr>
				<td>密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
				<td><label> <input name="password" type="password" class="input_1" id="password" />
				</label></td>
			</tr>
			<tr>
				<td>验证码：</td>
				<td><input name="usercheck" type="text" id="usercheck"
					class="input_1 input_2" size="7" /><img class="captcha" src="<?php echo base_url('/admin/index/captcha'); ?>" /></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><label>
